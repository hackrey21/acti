                                ...
                                <div class="row">
                                  <div class="col-sm-12" id="news">
                                    <table id="example" class="display expandable-table dataTable no-footer" style="width: 100%" role="grid">
                                      <thead>
                                        <tr role="row">
                                          <th class="select-checkbox sorting_disabled col" rowspan="1" colspan="1" aria-label="Quote#" style="width: 70px">
                                            ID
                                          </th>
                                          <th class="select-checkbox sorting_disabled col" rowspan="1" colspan="1" aria-label="Quote#" style="width: 70px">
                                            Co.
                                      ...
                                      <tbody>
                                        <?php
                                        $stmt = $pdo->prepare("SELECT * FROM excel_info WHERE idExcel = $dato_descifrado");
                                        $stmt->execute();
                                        $row = $stmt->fetchAll();
                                        $idk = 0;
                                        foreach ($row as $data) {
                                        ...
                                        ?>
                                          <tr class="odd">
                                            ...
                                            <td class="select-checkbox" >
                                              <?php echo $data['Num_Act']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Nom_Act']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Mer']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['adqui_date']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Cost']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Val_neto_libros']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Moneda']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Area_esp']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Ubicacion']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Existe_A']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['A_etiquetado']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Foto']; ?>
                                            </td>
                                            ...
                                            <td class="select-checkbox" >
                                              <?php echo $data['No_serie']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Pedimento']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['E_actual']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['N_adiction']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Exp_apoyo']; ?>
                                            </td>
                                            <td class="select-checkbox" >
                                              <?php echo $data['Auditor']; ?>
                                            </td>

                                            <td>
                                              <form action="" method="POST">
                                                <input type="hidden" name="txtID" value="3" />
