...
(function (f) {
  ...
  function Ga(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        d &&
        "No hay datos aun" === b.sEmptyTable &&
  ...
  function tb(a) {
    ...
    var container = $("<div/>"); // Crear el contenedor div
    container.append(e);
    container.append(icon);

  
    var l = $("<div><label/></div>").addClass(b.sLength);
    if (!a.aanFeatures.l) {
      l[0].id = c + "_length";
    }
  
    l.children().append(
      a.oLanguage.sLengthMenu.replace("_MENU_", container[0].outerHTML) // Usar el contenedor en lugar del select directamente
    );
    ...
    $(a.nTable).on("length.dt.DT", function (b, c, d) {
      if (a === c) {
        $("select", l).val(d);
      }
    });
  ...
  function yb(a) {
    ...
    b = $("<div/>").addClass(a.oClasses.sPaging + b)[0];
    var h = a.aanFeatures;
    if (!d) {
      c.fnInit(a, b, e);
    }
  ...
  q.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "No hay datos aun",
      sInfo: "Mostrando _START_ a _END_ de _TOTAL_ Paginas",
      sInfoEmpty: "Mostrando 0 a 0 de 0 Paginas",
      sInfoFiltered: "(Paginas totales de filtrado _MAX_)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
